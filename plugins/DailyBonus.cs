...
namespace Core {
    public class DailyBonus : Plugin {
        ...
        public static bool AutoReward = true; // Reward users automoatically on join (true) or force them to type /daily (false)
        public static int amount = 15; // The amount given to the player
